...
class MCPClient {
    constructor(baseUrl = null) {
        this.baseUrl = baseUrl || (typeof PortConfig !== 'undefined' ? PortConfig.getMcpServiceUrl() : 'http://localhost:3001');
    ...
    preprocessCommandMessage(message) {
        ...
        if (isDbCommand) {
            console.log('📊 SQL command detected in MCP client, preserving SQL syntax');
            ...
            if (match) {
                ...
                console.log('📊 Extracted SQL from quotes in client:', sqlContent);
